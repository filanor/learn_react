 ...
 * Фрагменты React
 * 
 *  Общим примером в React является компонент, возвращающий несколько элементов. 
 *  Фрагменты позволяют группировать список потомков без добавления дополнительных узлов в DOM:
 */
render() {
    return (
      <React.Fragment>
...
/*
  Фрагменты, объявленные с явным синтаксисом <React.Fragment>, могут иметь ключи. 
...
/*  
key- это единственный атрибут, который может быть передан фрагменту. 
*/